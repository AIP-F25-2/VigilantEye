...
def get_videos():
    ...
    try:
        ...
        if search_params.get('category'):
            query = query.filter(Video.video_metadata['category'].astext == search_params['category'])
...
def stream_video(video_id):
    ...
    try:
        ...
        if not video.video_metadata.get('allow_streaming', True):
...
def download_video(video_id):
    ...
    try:
        ...
        if not video.video_metadata.get('allow_download', True):
