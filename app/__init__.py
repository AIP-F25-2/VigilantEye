...
def create_app():
    ...
    app.register_blueprint(web_auth_bp)  # Web authentication routes (/, /login, /register, /logout, /dashboard, /videos, /projects, /recordings)
    ...
    app.register_blueprint(device_bp, url_prefix='/api/v2')
    app.register_blueprint(security_bp, url_prefix='/api/v2/security')
